...
class _VoiceRecognitionScreenState extends State<VoiceRecognitionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer2<VoiceRecognitionProvider, AppProvider>(
      builder: (context, provider, language, child) {
        String? currentText = '';
        return Scaffold(
          backgroundColor:
              provider.colorMode == 'light' ? Colors.white : Colors.black,
          body: SafeArea(
            child: Container(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            ...
                            style: theme.textTheme.titleLarge!.copyWith(
                              color: provider.colorMode == 'light'
                                  ? Colors.black
                                  : Colors.white,
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (context.mounted) {
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content:
                                              Text(provider.saveStatusMessage),
                                        ),
                                      );
                                    }
                                  },
